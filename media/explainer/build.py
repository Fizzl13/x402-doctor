...
out/x402-doctor-explainer.mp4 (1920x1080 H.264 + AAC, fade in/out),
out/x402-doctor-explainer.srt and out/poster.jpg.
"""
...
def main():
    ...
    mp4 = os.path.join(out, "x402-doctor-explainer.mp4")
